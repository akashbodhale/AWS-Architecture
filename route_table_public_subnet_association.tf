...
resource "aws_route_table_association" "private_subnet_association" {
  ...
  depends_on = [aws_subnet.aws_gogreen_private_subnets, aws_route_table.gogreen_private_route_table]
  subnet_id      = element(aws_subnet.aws_gogreen_private_subnets[*].id, count.index)
